...
const TOKEN =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..zVL2MTaEHyi4sd9SYuasDgWaUnV8HqD-O6x5QCrpExY";
...
(async () => {
  ...
  parentPort.postMessage(
    `[Thread #${workerData.id}] finished sending messages`
  );
  parentPort.postMessage(
